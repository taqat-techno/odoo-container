...
# cbor2==5.4.2 setup.py needs pkg_resources; setuptools>=82 removed it
# Use PIP_CONSTRAINT to force build-isolation envs to also use setuptools<81
COPY requirements.txt /opt/odoo/requirements.txt
RUN echo "setuptools<81" > /tmp/pip-constraint.txt \
