...
<h1 align="center">Odoo 18 &mdash; Docker Development Environment</h1>
...
<p align="center">
  <a href="https://github.com/taqat-techno/odoo-container/releases/tag/v18.0.0"><img src="https://img.shields.io/badge/release-v18.0.0-blue" alt="Release"/></a>
...
A **complete, containerized Odoo 18 Enterprise development environment**. Everything you need to develop, test, and run Odoo modules locally without installing Python, PostgreSQL, or any system dependencies on your machine.
...
```bash
git clone -b v18 https://github.com/taqat-techno/odoo-container.git odoo18
cd odoo18
```
...
- **Python SDK** &mdash; point to Python 3.11 interpreter in the container
...
|-----------|---------|---------|
| **Odoo** | 18.0 Enterprise | ERP framework |
| **Python** | 3.11 | Runtime |
...
Odoo Enterprise Edition is subject to the [Odoo Enterprise License v1.0](https://www.odoo.com/documentation/18.0/legal/licenses.html#odoo-enterprise-license).
