...
```
  ...
  (HTTP)                 |   |          odoo16_web             |   |
                         |   |                                   |   |
  localhost:8072  ------>|   |   Odoo 16 Enterprise              |   |
  (Gevent/WebSocket)     |   |   Python 3.10 | Debian Bullseye   |   |
                         |   |                                   |   |
...
git clone -b v16 https://github.com/taqat-techno/odoo-container.git client-project
cd client-project
