# Odoo 15 Enterprise — Docker Container

Branch `v15` of `taqat-techno/odoo-container`.

This repository contains the **Odoo 15 Enterprise source code** pre-configured for Docker-based development. It is designed to work with a shared Docker image hosted on Docker Hub — no local image build required.
...
```
odoo-container/ (v15 branch)
├── odoo/                    ← Odoo 15 Enterprise source (standard addons)
├── conf/
...
```bash
git clone -b v15 https://github.com/taqat-techno/odoo-container.git my-project-odoo15
cd my-project-odoo15
```
