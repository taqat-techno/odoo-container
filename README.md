# Odoo 19 Enterprise — Docker Container

Branch `v19` of `taqat-techno/odoo-container`.

This repository contains the **Odoo 19 Enterprise source code** pre-configured for Docker-based development. It is designed to work with a shared Docker image hosted on Docker Hub — no local image build required.
...
```
odoo-container/ (v19 branch)
├── odoo/                    ← Odoo 19 Enterprise source (standard addons)
├── conf/
...
```bash
git clone -b v19 https://github.com/taqat-techno/odoo-container.git my-project-odoo19
cd my-project-odoo19
```
