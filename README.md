# Odoo 14 - Docker Development Environment

Ready-to-use Docker setup for Odoo 14 Enterprise development with full IDE integration.

## Quick Start

```bash
# Clone this version
git clone -b v14 https://github.com/taqat-techno/odoo-container.git
cd odoo-container
