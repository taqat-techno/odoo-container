# Odoo 17 - Docker Development Environment

Ready-to-use Docker setup for Odoo 17 Enterprise development with full IDE integration.

## Quick Start

```bash
# Clone this version
git clone -b v17 https://github.com/taqat-techno/odoo-container.git
cd odoo-container
