# Odoo 17 Enterprise — Docker Container

Branch `v17` of `taqat-techno/odoo-container`.

This repository contains the **Odoo 17 Enterprise source code** pre-configured for Docker-based development. It is designed to work with a shared Docker image hosted on Docker Hub — no local image build required.
...
```
odoo-container/ (v17 branch)
├── odoo/                    ← Odoo 17 Enterprise source (standard addons)
├── conf/
...
```bash
git clone -b v17 https://github.com/taqat-techno/odoo-container.git my-project-odoo17
cd my-project-odoo17
```
