...
<h1 align="center">Odoo 14 &mdash; Docker Development Environment</h1>
...
<p align="center">
  <a href="https://github.com/taqat-techno/odoo-container/releases/tag/v14.0.0"><img src="https://img.shields.io/badge/release-v14.0.0-blue" alt="Release"/></a>
...
A **complete, containerized Odoo 14 Enterprise development environment**. Everything you need to develop, test, and run Odoo modules locally without installing Python, PostgreSQL, or any system dependencies on your machine.
...
```bash
git clone -b v14 https://github.com/taqat-techno/odoo-container.git odoo14
cd odoo14
```
...
```
Docker Compose (odoo14_net)
  +-- odoo14_db  (PostgreSQL 12)
  |   +-- Port: 5433 -> 5432
  |   +-- Health: pg_isready
  |
  +-- odoo14_web (Odoo 14 Enterprise)
      +-- Port: 8069 -> 8069 (HTTP)
...
- **Python SDK** &mdash; point to Python 3.8 interpreter in the container
...
|-----------|---------|---------|
| **Odoo** | 14.0 Enterprise | ERP framework |
| **Python** | 3.8 | Runtime |
| **PostgreSQL** | 12 | Database |
| **Debian** | Buster (slim) | Base OS |
...
|
|-- odoo/                         # Odoo 14 Enterprise source (READ-ONLY)
...
docker inspect --format="{{.State.Health.Status}}" odoo14_web
```
...
Odoo Enterprise Edition is subject to the [Odoo Enterprise License v1.0](https://www.odoo.com/documentation/14.0/legal/licenses.html#odoo-enterprise-license).
