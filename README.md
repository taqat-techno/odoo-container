...
<h1 align="center">Odoo 19 &mdash; Docker Development Environment</h1>
...
<p align="center">
  <a href="https://github.com/taqat-techno/odoo-container/releases/tag/v19.0.0"><img src="https://img.shields.io/badge/release-v19.0.0-blue" alt="Release"/></a>
...
A **complete, containerized Odoo 19 Enterprise development environment**. Everything you need to develop, test, and run Odoo modules locally without installing Python, PostgreSQL, or any system dependencies on your machine.
...
```
  ...
  (HTTP)                 |   |          odoo19_web             |   |
                         |   |                                   |   |
  localhost:8072  ------>|   |   Odoo 19 Enterprise              |   |
  (Gevent/WebSocket)     |   |   Python 3.12 | Debian Bookworm   |   |
                         |   |                                   |   |
...
- **Python SDK** &mdash; point to Python 3.12 interpreter in the container
...
|-----------|---------|---------|
| **Odoo** | 19.0 Enterprise | ERP framework |
| **Python** | 3.12 | Runtime |
...
|
|-- odoo/                         # Odoo 19 Enterprise source (READ-ONLY)
...
git clone -b v19 https://github.com/taqat-techno/odoo-container.git client-project
cd client-project
...
Odoo Enterprise Edition is subject to the [Odoo Enterprise License v1.0](https://www.odoo.com/documentation/19.0/legal/licenses.html#odoo-enterprise-license).
