# Odoo 18 Enterprise — Docker Container

Branch `v18` of `taqat-techno/odoo-container`.

This repository contains the **Odoo 18 Enterprise source code** pre-configured for Docker-based development. It is designed to work with a shared Docker image hosted on Docker Hub — no local image build required.
...
```
odoo-container/ (v18 branch)
├── odoo/                    ← Odoo 18 Enterprise source (standard addons)
├── conf/
...
```bash
git clone -b v18 https://github.com/taqat-techno/odoo-container.git my-project-odoo18
cd my-project-odoo18
```
