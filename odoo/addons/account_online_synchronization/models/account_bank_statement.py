...
class AccountBankStatement(models.Model):
    ...
    def _online_sync_bank_statement(self, transactions, online_account):
        ...
        for journal in online_account.journal_ids:
            ...
            existing_transactions = set([t.online_transaction_identifier for t in existing_transactions_ids])
            ...
            for transaction in sorted_transactions:
                transaction_identifier = transaction['online_transaction_identifier']
