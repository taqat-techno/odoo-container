    ...
    def _prepare_lines_for_analytic_groupby(self, analytic_distribution=False):
        ...
        for fname, data_type in stored_move_line_fields:
            if fname in changed_equivalence_dict:
                ...
                selected_fields.append(sql.SQL(f'to_jsonb(UNNEST(ARRAY_REMOVE(ARRAY[account_analytic_line.{analytic_cols}], NULL))) AS "account_move_line.analytic_distribution"'))
