    ...
    def test_xml_edi_polizas_simple(self):
        ...
        expected_xml = """<?xml version='1.0' encoding='utf-8'?>
            <PLZ:Polizas
                ...
                <PLZ:Poliza Fecha="2017-01-01" Concepto="Customer Invoices" NumUnIdenPol="INV/2017/01/0002">
                    <PLZ:Transaccion Concepto="Customer Invoices - INV/2017/01/0002" DesCta="Clientes nacionales" NumCta="105.01.01" Haber="0.00" Debe="8480.00">
        ...
        expected_xml = """<?xml version='1.0' encoding='utf-8'?>
            <PLZ:Polizas xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:PLZ="http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo" xsi:schemaLocation="http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo/PolizasPeriodo_1_3.xsd" Version="1.3" TipoSolicitud="AF" NumOrden="ABC6987654/99" Anio="2017" Mes="01" RFC="EKU9003173C9">
                <PLZ:Poliza Fecha="2017-01-02" Concepto="Bank" NumUnIdenPol="BNK1/2017/01/0002">
                    <PLZ:Transaccion Concepto="Bank - Customer Payment $ 1,820.00 - partner_a - 01/02/2017" DesCta="Outstanding Receipts" NumCta="102.01.03" Haber="0.00" Debe="1820.00">
                ...
                <PLZ:Poliza Fecha="2017-01-01" Concepto="Customer Invoices" NumUnIdenPol="INV/2017/01/0002">
                    <PLZ:Transaccion Concepto="Customer Invoices - INV/2017/01/0002" DesCta="Clientes nacionales" NumCta="105.01.01" Haber="0.00" Debe="106000.00">
