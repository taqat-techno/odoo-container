...
class TestIrnProcess(L10nInTestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.purchase_igst_1_rc = AccountChartTemplate.ref('igst_purchase_1_rc')
        cls.purchase_igst_18_rc = AccountChartTemplate.ref('igst_purchase_18_rc')
