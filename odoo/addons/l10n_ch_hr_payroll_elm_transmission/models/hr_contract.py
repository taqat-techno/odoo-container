...
""")
    ...
    def _get_allowed_contract_type_ids(self):
        return (self.env.ref("l10n_ch_hr_payroll.l10n_ch_contract_type_indefiniteSalaryMth") +
                ...
                self.env.ref("l10n_ch_hr_payroll_elm.l10n_ch_contract_type_indefiniteSalaryHrs") +
                self.env.ref("l10n_ch_hr_payroll_elm.l10n_ch_contract_type_fixedSalaryHrs") +
                self.env.ref("l10n_ch_hr_payroll_elm.l10n_ch_contract_type_indefiniteSalaryNoTimeConstraint") +
                self.env.ref("l10n_ch_hr_payroll_elm.l10n_ch_contract_type_fixedSalaryNoTimeConstraint") +
                self.env.ref("l10n_ch_hr_payroll_elm.l10n_ch_contract_type_administrativeBoard")).ids
