...
class HrVersion(models.Model):
    ...
    l10n_eg_housing_allowance = fields.Monetary(string='Egypt Housing Allowance', groups="hr_payroll.group_hr_payroll_user")
    l10n_eg_transportation_allowance = fields.Monetary(string='Egypt Transportation Allowance', groups="hr_payroll.group_hr_payroll_user")
    l10n_eg_other_allowances = fields.Monetary(string='Egypt Other Allowances', groups="hr_payroll.group_hr_payroll_user")
    l10n_eg_number_of_days = fields.Integer(
        string='Provision number of days', groups="hr_payroll.group_hr_payroll_user",
    ...
    l10n_eg_total_number_of_days = fields.Integer(
        string='Total Number of Days', groups="hr_payroll.group_hr_payroll_user",
    ...
    l10n_eg_social_insurance_reference = fields.Monetary(string='Social Insurance Reference Amount', groups="hr_payroll.group_hr_payroll_user")
    l10n_eg_total_leave_days = fields.Float(string='Total Leave Days', default=21, groups="hr_payroll.group_hr_payroll_user")
