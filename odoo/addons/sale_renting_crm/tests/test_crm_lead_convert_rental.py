...
@tagged('lead_manage')
class TestLeadConvertToRental(crm_common.TestCrmCommon):
    ...
    def test_lead_convert_to_rental_create(self):
        ...
        convert = self.env['crm.lead.rental'].with_context({
        ...
        action = convert.action_new_rental()
    ...
    @users('user_sales_salesman')
    def test_lead_convert_to_rental_false_match_create(self):
        lead = self.lead_1.with_user(self.env.user)
