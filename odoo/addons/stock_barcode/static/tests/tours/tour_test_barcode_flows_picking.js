...
registry.category("web_tour.tours").add("test_delivery_pack_from_different_location", {
    ...
    steps: () => [
        ...
        { trigger: ".o_barcode_line:not(.o_selected)", run: "scan product1" },
        {
            ...
            run: () => {
                helper.assertLinesCount(2);
                helper.assertLineSourceLocation(0, ".../Section 1");
                helper.assertLineSourceLocation(1, ".../Section 2");
            }
        },
...
registry.category("web_tour.tours").add("test_delivery_scan_unreserved_lot_as_subline", {
    test: true,
    steps: () => [
        {
            trigger: ".o_barcode_client_action",
        ...
        { trigger: ".o_barcode_line[data-barcode='product1'].o_selected", run: "scan Lot0002" },
        {
            trigger: ".o_barcode_line[data-barcode='productlot1'].o_selected button.o_toggle_sublines",
            run: function() {
                helper.assertLinesCount(2);
            }
        },
    ...
    steps: () => [
        ...
        { trigger: ".o_stock_barcode_main_menu", run: "scan SUMOEWNC" },
        {
            ...
            run: () => {
                helper.assertLinesCount(2);
                const [ line1, line2 ] = helper.getLines();
                helper.assert(line1.querySelector(".o_line_lot_name").innerText, "LN002")
                helper.assertLineQty(line1, "0 / 2");
                helper.assert(line2.querySelector(".o_line_lot_name").innerText, "LN001")
