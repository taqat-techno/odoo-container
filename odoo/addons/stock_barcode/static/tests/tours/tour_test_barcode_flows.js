...
tour.register('test_receipt_reserved_2', {test: true}, [
    ...
    // Checks commands to change current page work as expected.
    {
        trigger: '.o_current_dest_location:contains("WH/Stock/Section 4")',
        run: "scan O-CMD.PAGER-FIRST"
    },
    {
        trigger: '.o_current_dest_location:contains("WH/Stock")',
        run: "scan O-CMD.NEXT"
    },
    {
        trigger: '.o_current_dest_location:contains("WH/Stock/Section 1")',
    ...
    {
        trigger: '.o_current_dest_location:contains("WH/Stock")',
        run: "scan O-CMD.PAGER-LAST"
    },

    {
        extra_trigger: '.o_current_dest_location:contains("WH/Stock/Section 4")',
        trigger: '.o_add_line',
    },
    {
        trigger: '.o_field_widget[name="product_id"]',
...
tour.register('test_delivery_reserved_lots_1', {test: true}, [
    ...
    { trigger: '.o_barcode_line.o_selected', run: 'scan lot3' },
    {
        ...
        run: function() {
            ...
            helper.assert(line1.querySelector('.o_barcode_scanner_qty').innerText, "1");
            helper.assert(line1.querySelector('.o_line_button.o_add_quantity').innerText, "+1");
            helper.assert(line2.querySelector('.o_barcode_scanner_qty').innerText, "1/ 2");
    ...
    { trigger: '.o_barcode_client_action', run: 'scan lot1' },
    {
        ...
        run: function() {
            ...
            helper.assert(line1.querySelector('.o_line_button.o_add_quantity').innerText, "+1");
            helper.assert(line2.querySelector('.o_barcode_scanner_qty').innerText, "0/ 3");
            helper.assert(line2.querySelector('.o_line_button.o_add_quantity').innerText, "+2");
            helper.assert(line3.querySelector('.o_barcode_scanner_qty').innerText, "2/ 2");
            helper.assert(line3.querySelector('.o_line_button.o_add_quantity').innerText, "+1");
        },
    },
    ...
    { trigger: '.o_barcode_line.o_selected:not(.o_line_completed)', run: 'scan lot2' },
    {
        ...
        run: function() {
            ...
            helper.assert(line2.querySelector('.o_barcode_scanner_qty').innerText, "2/ 3");
