...
export default class BarcodePickingModel extends BarcodeModel {
    ...
    _processLocationSource(barcodeData) {
        ...
        if (!this.record.immediate_transfer && !this._isSublocation(barcodeData.location, this._defaultLocation())) {
    ...
    async _processPackage(barcodeData) {
        ...
        if (alreadyExisting) {
            ...
            this.dialogService.add(ConfirmationDialog, {
                body: sprintf(
                    _t("You have already scanned %s items of this package. Do you want to scan the whole package?"),
                    alreadyExisting
                ),
