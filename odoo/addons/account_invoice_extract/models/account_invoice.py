    ...
    def _save_form(self, ocr_results, no_ref=False):
        ...
        with self.get_form_context_manager() as move_form:
            ...
            if not move_form.partner_id:
                ...
                if not move_form.partner_id and iban_ocr:
            ...
            if not move_form.invoice_line_ids:
                if self.user_has_groups('base.group_multi_currency') and (
                        not move_form.currency_id or move_form.currency_id == self._get_default_currency()):
