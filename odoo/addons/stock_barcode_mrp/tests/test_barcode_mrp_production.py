...
class TestMRPBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_create_all_transfers_for_3_step_manufacturing(self):
        ...
        pick_component_transfer, store_final_transfer = mos.picking_ids
        self.assertEqual(pick_component_transfer.picking_type_id.name, 'Pick Components')
        self.assertEqual(store_final_transfer.picking_type_id.name, 'Store Finished Product')
