...
class L10nCzTaxOffice(models.Model):
    ...
    workplace_code = fields.Integer(string="Territorial Office", required=True, group_operator=False)
    code = fields.Integer(string="Code", required=True, group_operator=False)
