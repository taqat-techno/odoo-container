...
class TestSwissdecCommon(AccountTestInvoicingCommon):
    ...
    def _l10n_ch_generate_swissdec_demo_data(cls, company):
        ...
        with freeze_time("2021-11-01"):
            ...
            cdi_hourly = {"contract_type_id": cls.env.ref('l10n_ch_hr_payroll_elm.l10n_ch_contract_type_indefiniteSalaryHrs').id}
            cdd_hourly = {"contract_type_id": cls.env.ref('l10n_ch_hr_payroll_elm.l10n_ch_contract_type_fixedSalaryHrs').id}
            ...
            cdi_ntc = {"contract_type_id": cls.env.ref('l10n_ch_hr_payroll_elm.l10n_ch_contract_type_indefiniteSalaryNoTimeConstraint').id}
            cdi_fntc = {"contract_type_id": cls.env.ref('l10n_ch_hr_payroll_elm.l10n_ch_contract_type_fixedSalaryNoTimeConstraint').id}
            ...
            administrative = {"contract_type_id": cls.env.ref('l10n_ch_hr_payroll_elm.l10n_ch_contract_type_administrativeBoard').id}
