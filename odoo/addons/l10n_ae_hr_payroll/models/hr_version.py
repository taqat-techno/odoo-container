...
class HrVersion(models.Model):
    ...
    l10n_ae_is_computed_based_on_daily_salary = fields.Boolean(string="Computed Based On Daily Salary", groups="hr_payroll.group_hr_payroll_user",
                                                               help="If True, The EOS will be computed based on the daily salary provided rather than the basic salary")
    l10n_ae_eos_daily_salary = fields.Float(string="Daily Salary", groups="hr_payroll.group_hr_payroll_user")
