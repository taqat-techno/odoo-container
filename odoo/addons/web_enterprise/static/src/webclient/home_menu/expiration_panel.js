...
export class ExpirationPanel extends Component {
    ...
    async _onCodeSubmit() {
        ...
        const linkedSubscriptionUrl = await this.orm.call("ir.config_parameter", "get_param", [
            "database.already_linked_subscription_url",
        ])
        const emailLinked = await this.orm.call("ir.config_parameter", "get_param", ["database.already_linked_email"])
