...
class DanishReportCustomHandler(models.AbstractModel):
    ...
    ERROR_MESSAGES = {
        '4801': _("RSU is not delegated by the legal entity (See Onboard Legal Entities: https://skat.dk/erhverv/moms/momsregnskab)."),
        '4802': _("The VAT period is not open."),
        '4803': _("The VAT period has not ended."),
        '4804': _("The VAT period is more than 3 years old."),
        '4810': _("The VAT statement draft has not been approved."),
        '4811': _("No receipt, the provisional VAT return has been rejected."),
        '4812': _("Receipt does not exist."),
        '4813': _("The VAT statement draft does not exist."),
        '4816': _("The value in the 'description' field does not exist. Should be 'Moms'."),
        '4817': _("The search start date is later than the search end date."),
        '8283': _("Search period cannot span more than 2 years."),
    }

    # Allows to translate the errors returned by IAP
    ERROR_MESSAGES_IAP = {
        'error_subscription': _("An error has occurred when trying to verify your subscription."),
        'dbuuid_not_exist': _("Your database uuid does not exist."),
        'not_enterprise': _("You do not have an Odoo enterprise subscription."),
        'not_prod_env': _("Your database is not used for a production environment."),
        'not_active_db': _("Your database is not yet activated."),
        'error_deprecated': _("Please upgrade the Danish Localization - RSU module.")
    }
