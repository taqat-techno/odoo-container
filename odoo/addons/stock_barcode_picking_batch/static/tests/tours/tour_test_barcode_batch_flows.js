...
registry.category("web_tour.tours").add("test_pack_batch_in_multiple_packages", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product1)):has(.o_picking_label:contains('Lovely receipt 1'))",
            run: "scan product1",
        },
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product1)):has(.o_picking_label:contains('Lovely receipt 1')):has(.qty-done:contains(1))",
            run() {},
        },
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product1)):has(.o_picking_label:contains('Lovely receipt 2')) .o_add_quantity",
            run: "click",
        },
        {
        ...
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product1)):has(.o_picking_label:contains('Lovely receipt 1')) .o_add_quantity",
            run: "click",
        },
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product2)):has(.o_picking_label:contains('Lovely receipt 1')) .o_add_quantity",
            run: "click",
        },
        {
            trigger: ".o_barcode_line:has(.product-label:contains(product2)):has(.o_picking_label:contains('Lovely receipt 2')) .o_add_quantity",
            run: "click",
        },
        {
            trigger: ".o_barcode_lines:not(:has(.o_barcode_line:contains(product1) .o_add_quantity))",
            run() {},
        },
        {
            trigger: ".o_put_in_pack",
        ...
        {
            trigger: ".o_barcode_lines:not(:has(.o_barcode_line:not(:has(.result-package))))",
            run: () => {
                helper.assertLinesCount(5);
                const [line1, line2, line3, line4, line5] = helper.getLines();
