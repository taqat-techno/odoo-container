    ...
    def _inverse_appointment_resource_id_or_capacity(self):
        ...
        for event in self:
            if not event.booking_line_ids and event.appointment_resource_id:
                ...
                booking_lines_sudo = event.booking_line_ids.sudo()
                booking_lines_sudo.appointment_resource_id = event.appointment_resource_id
                booking_lines_sudo.capacity_reserved = min(
                    event.resource_total_capacity_reserved or booking_lines_sudo.capacity_reserved,
