...
class TestPlanning(TestCommonPlanning, MockEmail):
    ...
    def setUpClass(cls):
        ...
        cls.env.user.company_id.resource_calendar_id = cls.calendar
    ...
    def test_copy_slots_when_time_off(self):
        ...
        """
        self.employee_bert.resource_calendar_id = self.calendar.id
        ...
        self.env['resource.calendar.leaves'].create({
            ...
            'calendar_id': self.employee_bert.resource_id.calendar_id.id,
