...
from .sale_order import SUBSCRIPTION_PROGRESS_STATE, SUBSCRIPTION_CLOSED_STATE
...
class SaleOrderLine(models.Model):
    ...
    def _compute_discount(self):
        ...
        for line in self:
            ...
            if not line.recurring_invoice and not line.order_id.subscription_state in SUBSCRIPTION_CLOSED_STATE:
