...
registry
    ...
    .add("test_add_component_from_shop_foor_in_multi_step_manufacturing", {
        ...
        steps: () => [
            ...
            {
                context: "Add Courage to the MO components",
                trigger: ".o_mrp_display_record .card-footer button.btn-light.py-3",
                run: "click",
            },
            {
            ...
            {
                context: "Check that the last piece of Courage was added to the MO",
                trigger: ".o_mrp_record_line:contains(Courage):has(button:contains(2.00))",
                run: () => {},
            },
        ],
    });
