...
class ShareRoute(http.Controller):
    ...
    def _get_record(self, res_id, share_id=None, share_token=None):
        """ returns the record from which to download the file"""
    ...
    def _get_file_response(self, res_id, share_id=None, share_token=None, field='raw', as_attachment=None):
        ...
        record = self._get_record(res_id, share_id, share_token)
        if record.type == 'url':
