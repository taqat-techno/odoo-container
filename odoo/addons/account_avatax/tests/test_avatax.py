...
class TestAccountAvalaraInternalCommon(TestAccountAvataxCommon):
    def assertInvoice(self, invoice, test_exact_response):
        ...
        if test_exact_response:
            self.assertRecordValues(invoice, [{
                'amount_total': test_exact_response["totalAmount"] + test_exact_response["totalTax"],
                'amount_untaxed': test_exact_response["totalAmount"],
                'amount_tax': test_exact_response["totalTax"],
            }])
