...
class TestPoSRental(TestPointOfSaleHttpCommon):
    ...
    def test_rental_qty_delivered(self):
        ...
        self.env.user.write({
            'groups_id': [
                (4, self.env.ref('sale_stock_renting.group_rental_stock_picking').id),
            ]
        })
        self.pos_user.write({
            'groups_id': [
          ...
          {'amount_paid': 20,
           ...
           'lines': [[0,
             ...
             {'discount': 0,
              ...
              'sale_order_line_id': self.order_line,
              'sale_order_origin_id': self.sale_order,
              'qty': 1,
              'tax_ids': []}], [0,
             0,
             {'discount': 0,
              ...
              'price_subtotal': 10,
              'price_subtotal_incl': 10,
              'sale_order_line_id': self.order_line_non_rental,
              'sale_order_origin_id': self.sale_order,
              'qty': 1,
              'tax_ids': []}]],
