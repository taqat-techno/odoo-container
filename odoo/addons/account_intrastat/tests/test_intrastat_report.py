    ...
    def test_intrastat_comparison_period(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('INV/2024/00002', 20.00, None),
                ('INV/2024/00001', None, 20.00),
                ('Dispatch - None - 22042176 - ES - NL000099998B57 - BE - 102', 20.00, None),
                ('INV/2024/00004', 20.00, None),
                ('Dispatch - None - 22042176 - ES - BE0475646428 - BE - 102', None, 20.00),
                ('INV/2024/00003', None, 20.00),
            ],
        )
