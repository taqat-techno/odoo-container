...
class MxReportPartnerLedger(models.AbstractModel):
    ...
    def _diot_country_adapt(self, cc):
        ...
        return diot_country_dict.get(cc, cc)
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for partner in sorted_partners:
            ...
            p_columns = [
                ...
                partner.vat or '', self._diot_country_adapt(partner.country_id.code) or '',
            ...
            for tag, taxes in taxes_dict.items():
                ...
                for tax in taxes:
                    ...
                    total_credit += credit * tax.amount / 100
                if tag != tag_ret:
                ...
                for tag, taxes in taxes_dict.items():
                    ...
                    for tax in taxes.filtered(lambda t: t in line.tax_ids):
                        ...
                        if tag == tag_ret:
                            ...
                            continue
                        line_debit += line.debit
                        line_credit += line.credit * tax.amount / 100
                    if tag != tag_ret:
    ...
    def _l10n_mx_dpiva_txt_export(self, options):
        ...
        for line in txt_data:
            ...
            data[3] = month_names[date.month - 1]  # Period
