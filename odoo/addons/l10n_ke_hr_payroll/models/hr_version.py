...
class HrVersion(models.Model):
    ...
    l10n_ke_pension_contribution = fields.Monetary("Pension Contribution", groups="hr_payroll.group_hr_payroll_user")
    ...
    l10n_ke_education = fields.Monetary("Education", groups="hr_payroll.group_hr_payroll_user")
