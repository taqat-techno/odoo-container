...
patch(registry.category("web_tour.tours").get("industry_fsm_tour"), {
    steps() {
        ...
        originalSteps.splice(fsmStartStepIndex + 1, 0, {
            ...
            trigger: 'button[name="action_fsm_view_material"]',
            extra_trigger: 'div[name="timer_start"]',
            content: markup(_t('Let\'s <b>track the material</b> you use for your task.')),
            position: 'bottom',
            mobile: true,
        }, {
            ...
            position: "bottom",
            mobile: false,
        }, ...stepUtils.goBackBreadcrumbsMobile(markup(_t("Use the breadcrumbs to navigate to your <b>list of products</b>.")), undefined),
        {
            ...
            position: "bottom",
            mobile: false,
        }, ...stepUtils.goBackBreadcrumbsMobile(markup(_t("Use the breadcrumbs to return to your <b>task</b>.")), undefined));
