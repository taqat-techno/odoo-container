...
class TestFsmFlowSale(TestFsmFlowSaleCommon):
    ...
    def test_copy_task_sale_fields(self):
        ...
        copied_fsm_task = fsm_task.copy()
        copied_normal_task = normal_task.copy()

        self.assertFalse(copied_fsm_task.sale_order_id)
        self.assertFalse(copied_fsm_task.sale_order_id.invoice_ids)
        
        self.assertTrue(copied_normal_task.sale_order_id)
        self.assertTrue(copied_normal_task.sale_order_id.invoice_ids)
