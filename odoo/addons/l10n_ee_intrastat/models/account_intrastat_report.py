...
class IntrastatReportCustomHandler(models.AbstractModel):
    ...
    def _ee_intrastat_xlsx_get_data(self, options):
        query_res = self._ee_get_query_res(options)
    ...
    def _ee_get_col_order_and_title(self, intrastat_type):
        ...
        return {
            'arrivals': {
                ...
                'supplementary_unit_code': _("Unit"),
    ...
    def _ee_prepare_values_for_export(self, vals_list):
        for count, vals in enumerate(vals_list, start=1):
            ...
            vals['quantity'] = round(vals['quantity'] * vals['supplementary_units'] if vals['supplementary_units'] else vals['quantity'], 2)
