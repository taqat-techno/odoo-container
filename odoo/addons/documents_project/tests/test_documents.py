...
class TestCaseDocumentsBridgeProject(TestProjectSharingCommon):
    ...
    def test_document_linking_to_workspace_when_changing_task_project(self):
        ...
        project_folder = self.env.ref('documents_project.documents_project_folder', raise_if_not_found=False)
    ...
    def test_document_folder_remains_unchanged_when_project_use_documents_is_disabled(self):
        ...
        self.attachment_txt.write({
            'res_model': 'project.task',
            'res_id': self.task_1.id,
            'folder_id': self.project_pigs.documents_folder_id,
        })
    ...
    def test_document_folder_remains_when_project_changes(self):
        ...
        folder_b, folder_general = self.env['documents.folder'].create([
            {'name': 'Folder B'},
            {'name': 'General'},
        ])
