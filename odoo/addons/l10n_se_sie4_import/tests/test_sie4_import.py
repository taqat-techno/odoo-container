...
class AccountTestSIE4Import(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref='se'):
        ...
        cls.company_id = cls.setup_company_data('SIE 4 Test Company', chart_template=chart_template_ref)['company']
    ...
    def test_sie4_import_chart_of_account(self):
        ...
        accounts = self.env['account.account'].search([('company_id', '=', self.company_id.id), ('code', 'in', codes)])
    ...
    def test_sie4_import_opening_balance(self):
        ...
        self.assertSequenceEqual(opening_move.line_ids.account_id.mapped('code'), ('1030', '1060', '1110', '2019', '2030', '2060'))
    ...
    def test_sie4_import_opening_balance_with_unbalanced_ib(self):
        ...
        self.assertSequenceEqual(opening_move.line_ids.account_id.mapped('code'), ('1030', '1060', '999999'))
    ...
    def test_sie4_import_key_konto(self):
        ...
        self.assertDictEqual(data_map['account.account'], {
            'test.account_1001': {'company_id': company_id, 'code': '1001', 'name': 'item 1'},
            'test.account_1002': {'company_id': company_id, 'code': '1002', 'name': 'item 2'},
        })
    ...
    def test_sie4_import_key_ktyp(self):
        ...
        company_id = self.company_id.id
        self.assertDictEqual(data_map['account.account'], {
            'test.account_1001': {'company_id': company_id, 'code': '1001', 'account_type': "asset_receivable"},
            'test.account_1002': {'company_id': company_id, 'code': '1002', 'account_type': "liability_current"},
            'test.account_1003': {'company_id': company_id, 'code': '1003', 'account_type': "expense"},
            'test.account_1004': {'company_id': company_id, 'code': '1004', 'account_type': "income"},
        })
